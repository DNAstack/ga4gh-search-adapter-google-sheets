...
public class TableE2eTest extends BaseE2eTest {
    ...
    public void getTableInfoShouldWorkForFruitSheet() {
        ...
        given()
            ...
            .header("Authorization", "Bearer " + credential.getAccessToken().getTokenValue())
        .when()
            .get("/table/17LzrJJXKraCCsfCZJ1FqCsMAAoYTcntkpS5gSvOsx1w:Fruits/info")
        .then()
            .log().all()
            .log().ifValidationFails()
            .statusCode(200)
    ...
    public void getTableModelShouldWorkForFruitSheet() {
        ...
        given()
            ...
            .header("Authorization", "Bearer " + credential.getAccessToken().getTokenValue())
        .when()
            .get("/table/17LzrJJXKraCCsfCZJ1FqCsMAAoYTcntkpS5gSvOsx1w:Fruits/data-model")
        .then()
            .log().all()
            .log().ifValidationFails()
            .statusCode(200)
        ...
        given()
            ...
            .header("Authorization", "Bearer " + credential.getAccessToken().getTokenValue())
        .when()
            .get("/table/17LzrJJXKraCCsfCZJ1FqCsMAAoYTcntkpS5gSvOsx1w:Fruits/data")
        .then()
            .log().all()
            .log().ifValidationFails()
            .statusCode(200)
